...
public record LevelDataLoader(RegistryWrapper.WrapperLookup wrapperLookup) implements SimpleSynchronousResourceReloadListener {

    public static final Identifier ID = Player_level_skills.identifierOf("rest");
    ...
    public void reload(ResourceManager manager) {
        ...
        LOGGER.info("Skills loaded size = {}", LevelManager.SKILLS.size());
