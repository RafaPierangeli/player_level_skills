...
public class PlayerLevelSkillsScreen extends Screen {
    ...
    protected void init() {
        ...
        this.clientPlayerEntity = this.client.interactionManager.createPlayer(this.client.world, this.client.player.getStatHandler(), this.client.player.getRecipeBook(),playerInput, false);
        ...
        if (this.client != null && this.client.player != null) {
            ...
            if (!this.attributes.isEmpty()) {
                if (this.showAttributes) {
                    ...
                    context.drawTexture(RenderPipelines.GUI_TEXTURED, ATTRIBUTE_BACKGROUND_TEXTURE, this.x + 202, this.y, 0, 0, 82, 215, 256, 256);
            ...
            // Level label
            Text skillLevelText = Text.translatable("text.levelz.gui.level",this.levelManager.getOverallLevel()); // this.levelManager.getOverallLevel()
            ...
            context.drawTexture(RenderPipelines.GUI_TEXTURED, ICON_TEXTURE, this.x + 62, this.y + 21, 0, 105, (int) (130.0f * levelProgress), 5, 256, 256); // chance 5 to levelProgress
            // current xp label
            Text currentXpText = Text.translatable("text.levelz.gui.current_xp", experience, nextLevelExperience); //, experience, nextLevelExperience
