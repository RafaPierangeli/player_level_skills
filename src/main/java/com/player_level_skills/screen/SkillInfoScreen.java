...
public class SkillInfoScreen extends Screen implements Tab {
    ...
    protected void init() {
        ...
        addRestrictionLines(LevelManager.POTION_RESTRICTIONS, Text.translatable("restriction.levelz.potions").formatted(Formatting.BOLD), 4);
    }
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawText(this.textRenderer, Text.translatable("text.levelz.gui.short_level", this.levelManager.getSkillLevel(this.skill.getId())), this.x + 11 + this.textRenderer.getWidth(this.title), this.y + 7, 0xFF3F3F3F, false);
