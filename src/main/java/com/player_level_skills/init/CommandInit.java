        ...
        for (ServerPlayerEntity serverPlayerEntity : targets) {
            ...
            if (skillKey.equals("experience")) {
                ...
                if (skillKey.equals("points")) {
                    ...
                    serverPlayerEntity.getEntityWorld().getScoreboard().forEachScore(CriteriaInit.LEVELZ, serverPlayerEntity, score -> score.setScore(level));
                    Objects.requireNonNull(serverPlayerEntity.getEntityWorld().getServer()).getPlayerManager().sendToAll(new PlayerListS2CPacket(PlayerListS2CPacket.Action.UPDATE_GAME_MODE, serverPlayerEntity));
                } else {
