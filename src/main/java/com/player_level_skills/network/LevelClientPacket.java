...
import com.player_level_skills.network.packet.*;
    ...
    public static void init() {
        ...
        ClientPlayNetworking.registerGlobalReceiver(EnchantmentZPacket.PACKET_ID, (payload, context) -> {
            ...
            context.client().execute(() -> {
                ...
                Registry<Enchantment> registry = context.player().getEntityWorld().getRegistryManager().getOrThrow(RegistryKeys.ENCHANTMENT);
